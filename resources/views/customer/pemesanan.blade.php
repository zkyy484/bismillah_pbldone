        ...
        <div class="grid md:grid-cols-2 gap-8 p-6 md:p-10">
            ...
            <div class="flex flex-col justify-center">
                ...
                <p class="text-gray-700 leading-relaxed mb-6">
                    Untuk pemesanan desain rumah ini, harga satuannya menyesuaikan dengan ukuran panjang dan lebar dari rumah. 
                    Diharapkan pembeli dapat mengisi form ukuran rumah sebaik mungkin untuk menghindari kesalahan yang tidak diinginkan.
                </p>

                <!-- Gambar ilustrasi (opsional) -->
                <div class="rounded-lg overflow-hidden shadow">
                    <img src="https://via.placeholder.com/600x400?text=Desain+Rumah" 
                         alt="Desain Rumah" class="w-full object-cover">
                </div>
            </div>
            ...
            <div>
                ...
                <form action="" method="POST" class="space-y-5">
                    ...
                    <!-- Catatan -->
                    <div>
                        <label for="note" class="block text-gray-700 font-medium mb-2">Catatan Tambahan</label>
