{{-- <footer class="bg-gray-800 text-white mt-12">
    <div class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                <h3 class="text-lg font-semibold mb-4 text-primary">Tentang Kami</h3>
                <p class="text-gray-400 mb-4">Nama Toko adalah toko online terpercaya yang menyediakan berbagai produk berkualitas dengan harga terjangkau.</p>
            ...
            <div>
                <h3 class="text-lg font-semibold mb-4 text-primary">Link Cepat</h3>
                <ul class="space-y-2">
            ...
            <div>
                <h3 class="text-lg font-semibold mb-4 text-primary">Bantuan</h3>
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-400 hover:text-white transition">Panduan Ukuran</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition">Pembayaran</a></li>
                </ul>
            </div>
            
            <div>
                <h3 class="text-lg font-semibold mb-4 text-primary">Kontak</h3>
        ...
        <div class="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; 2023 Nama Toko. Semua Hak Dilindungi.</p>
        </div>
    </div>
</footer> --}}
