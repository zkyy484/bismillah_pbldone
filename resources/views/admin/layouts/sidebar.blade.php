<aside class="w-64 bg-cokelat text-putih h-full">
    ...
    <nav class="mt-6 px-3 space-y-1">
        <a href="{{ route('admin.dashboard') }}"
            ...
            <i
                class="fas fa-tachometer-alt mr-3 text-lg {{ request()->routeIs('admin.dashboard') ? 'text-cokelat' : 'group-hover:text-cokelat' }}"></i>
            <span
                class="{{ request()->routeIs('admin.dashboard') ? 'text-cokelat' : 'group-hover:text-cokelat' }}">Dashboard</span>
        </a>
        ...
        <a href="{{ route('admin.model_rumah.index') }}"
            ...
            <i
                class="fas fa-drafting-compass mr-3 text-lg {{ request()->routeIs() ? 'text-cokelat' : 'group-hover:text-cokelat' }}"></i>
        ...
        <a href="{{ route('all.order') }}"
            ...
            <i
                class="fas fa-file-alt mr-3 text-lg {{ request()->routeIs('all.order') ? 'text-cokelat' : 'group-hover:text-cokelat' }}"></i>
            <span
                class="{{ request()->routeIs('all.order') ? 'text-cokelat' : 'group-hover:text-cokelat' }}">Pesanan</span>
        </a>
        ...
        <a href="{{ route('transaksi') }}"
            ...
            <i
                class="fas fa-credit-card mr-3 text-lg {{ request()->routeIs('transaksi') ? 'text-cokelat' : 'group-hover:text-cokelat' }}"></i>
            <span
                class="{{ request()->routeIs('transaksi') ? 'text-cokelat' : 'group-hover:text-cokelat' }}">Transaksi</span>
        </a>
        ...
        <a href="{{ route('ulasan') }}"
            ...
            <i
                class="fas fa-star mr-3 text-lg {{ request()->routeIs('ulasan') ? 'text-cokelat' : 'group-hover:text-cokelat' }}"></i>
            <span
                class="{{ request()->routeIs('ulasan') ? 'text-cokelat' : 'group-hover:text-cokelat' }}">Penilaian</span>
        </a>
        ...
        <a href="{{ route('admin.banner') }}"
            ...
            <i
                class="fas fa-credit-card mr-3 text-lg {{ request()->routeIs('transaksi') ? 'text-cokelat' : 'group-hover:text-cokelat' }}"></i>
            <span
                class="{{ request()->routeIs('transaksi') ? 'text-cokelat' : 'group-hover:text-cokelat' }}">Banner Foto</span>
        </a>
    </nav>
    ...
    <div class="absolute bottom-14 left-0 right-0 p-4">
        <a href="{{ route('admin.profile') }}"
            ...
            <svg xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 text-coklat text-lg {{ request()->routeIs('admin.profile') ? 'text-cokelat' : 'group-hover:text-cokelat' }}"
